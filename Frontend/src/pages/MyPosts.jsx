            ...
            <div className="p-3">
              ...
              <div className="mt-3 flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <Link to={`/edit/${post._id}`} className="px-2 py-1 border rounded text-sm">Edit</Link>
                  <button onClick={() => handleDelete(post._id)} className="px-2 py-1 bg-red-500 text-white rounded text-sm">Delete</button>
                </div>
              </div>
            </div>
          </div>
